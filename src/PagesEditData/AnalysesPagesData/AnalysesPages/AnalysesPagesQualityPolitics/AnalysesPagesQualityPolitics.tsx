...
import { IQualityPoliticsPage } from '../../../../types/pagesTypes';
import {
  fetchPageById,
  handleSendQualityPoliticsPageData,
...
> = ({ initialLink, pageName, parentPageName }) => {
  ...
  const [initialData, setInitialData] = React.useState<IQualityPoliticsPage>({
  ...
  const [fieldsValues, setFieldsValues] =
    React.useState<IQualityPoliticsPage>(initialData);
        ...
        <>
          ...
          {openSaveModal && (
            <Modal
              ...
              handleEditData={() =>
                handleSendQualityPoliticsPageData(id as string, fieldsValues)
              }
            />
          )}
        </>
